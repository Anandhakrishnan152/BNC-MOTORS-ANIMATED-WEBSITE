        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          ...
          <div className="flex items-center gap-6">
            <div className="text-right">
              <p className="text-[10px] font-heading text-black tracking-widest uppercase mb-1 font-bold">CART_STATUS</p>
            ...
            >
              <div className="aspect-[4/5] bg-slate-50 relative flex items-center justify-center p-12 overflow-hidden">
                <img 
                  src={bike.image} 
                  alt={bike.name} 
                  className="w-full h-full object-contain grayscale opacity-80 group-hover:opacity-100 transition-all duration-700"
                />
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border-[1px] border-emerald-500/30 m-4">
                  <div className="absolute top-0 right-0 p-2 text-[7px] font-heading text-emerald-600 font-bold tracking-tighter">SCAN_V04.2</div>
                </div>
              </div>
              ...
              <div className="p-8 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-[10px] font-heading tracking-[0.2em] text-black uppercase leading-relaxed mb-8 font-bold">
                    {bike.tagline}
                  </p>
                  
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="border border-black/5 p-3">
                      <p className="text-[8px] text-black font-heading mb-1 uppercase font-bold">RANGE</p>
                      <p className="text-sm font-heading font-black text-black uppercase">{bike.specs[1].value} {bike.specs[1].unit}</p>
                    </div>
                    <div className="border border-black/5 p-3">
                      <p className="text-[8px] text-black font-heading mb-1 uppercase font-bold">SPEED</p>
                ...
                <div className="flex items-center justify-between border-t border-black/5 pt-8">
                  <div>
                    <span className="text-[8px] font-heading text-black block mb-1 uppercase tracking-widest font-bold">STARTING_AT</span>
