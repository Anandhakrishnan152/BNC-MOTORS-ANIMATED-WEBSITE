      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-40 items-center relative z-10">
        ...
        <div>
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <span className="text-emerald-600 font-heading text-xs tracking-[0.6em] uppercase mb-8 block font-black border-l-4 border-emerald-500 pl-6">ENERGY_MODULE_S4</span>
            ...
            <p className="text-gray-500 text-base mb-16 leading-relaxed font-heading tracking-[0.2em] uppercase text-sm font-bold">
              ...
              {[
                ...
                >
                  <div className="text-emerald-600 mb-5 group-hover:scale-110 transition-transform flex items-center gap-4">
                    {item.icon}
                    <h4 className="font-heading text-sm tracking-[0.3em] uppercase text-black font-black">{item.title}</h4>
                  </div>
                  <p className="text-black text-xs leading-tight font-heading tracking-widest uppercase font-bold">{item.desc}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
